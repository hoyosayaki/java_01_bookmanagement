...
public class Rireki implements ActionListener {
	...
	public void rireki() throws SQLException {
		...
		rtbl.setFont(new Font("Meiryo UI", Font.PLAIN, 16));
		rtbl.setRowHeight(28);

		JTableHeader jh = rtbl.getTableHeader();
		jh.setFont(new Font("Meiryo UI", Font.PLAIN, 16));

		//列の幅を調整する
		rtbl.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
		rtbl.setAutoCreateRowSorter(true);
		rtbl.getColumnModel().getColumn(0).setPreferredWidth(50);
		rtbl.getColumnModel().getColumn(1).setPreferredWidth(120);
		rtbl.getColumnModel().getColumn(2).setPreferredWidth(250);
		rtbl.getColumnModel().getColumn(3).setPreferredWidth(120);
		rtbl.getColumnModel().getColumn(4).setPreferredWidth(120);
		rtbl.getColumnModel().getColumn(5).setPreferredWidth(120);
		rtbl.getColumnModel().getColumn(6).setPreferredWidth(130);
		rtbl.getColumnModel().getColumn(7).setPreferredWidth(135);
		rtbl.getColumnModel().getColumn(8).setPreferredWidth(135);
		rtbl.getColumnModel().getColumn(9).setPreferredWidth(135);
	...
	public void lankPrint() throws SQLException {
		...
		lframe.setBounds(10, 10, 650, 750);
		...
		lendtimetitle.setFont(new Font("Meiryo UI", Font.PLAIN, 18));
		lpnl.add(lendtimetitle);

		st1 = new JLabel("●");
		st1.setBounds(130, 40, 40, 40);
		st1.setFont(new Font("Meiryo UI", Font.PLAIN, 18));
		st1.setForeground(Color.ORANGE);
		lpnl.add(st1);

		st2 = new JLabel("●");
		st2.setBounds(400, 40, 500, 40);
		st2.setFont(new Font("Meiryo UI", Font.PLAIN, 18));
		...
		poptitle.setFont(new Font("Meiryo UI", Font.PLAIN, 18));
		lpnl.add(poptitle);

		st3 = new JLabel("●");
		st3.setBounds(140, 260, 40, 40);
		st3.setFont(new Font("Meiryo UI", Font.PLAIN, 18));
		st3.setForeground(Color.MAGENTA);
		lpnl.add(st3);

		st4 = new JLabel("●");
		st4.setBounds(400, 260, 500, 40);
		st4.setFont(new Font("Meiryo UI", Font.PLAIN, 18));
		...
		highevaltitle.setFont(new Font("Meiryo UI", Font.PLAIN, 18));
		lpnl.add(highevaltitle);

		st5 = new JLabel("●");
		st5.setBounds(115, 480, 40, 40);
		st5.setFont(new Font("Meiryo UI", Font.PLAIN, 18));
		st5.setForeground(Color.BLUE);
		lpnl.add(st5);

		st6 = new JLabel("●");
		st6.setBounds(400, 480, 500, 40);
		st6.setFont(new Font("Meiryo UI", Font.PLAIN, 18));
